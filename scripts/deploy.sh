...
aws s3 cp scripts/gcp-login.sh ${S3_BUCKET}/scripts/gcp-login.sh
echo -e "${GREEN}✓ Uploaded gcp-login.sh${NC}"
...
for host in "${WORKER_HOSTS[@]}"; do
    ...
    # Deploy installer scripts + CLI login hooks (azure/ibmcloud/gcp-login.sh are
